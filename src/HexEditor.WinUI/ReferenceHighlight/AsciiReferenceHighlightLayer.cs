...
internal sealed class AsciiReferenceHighlightLayer : Canvas
{
	public AsciiReferenceHighlightLayer(IGraphicalHexView view, ITagAggregator<ReferenceTag> tagAggregator, VisualTheme theme) : base()
	{
		_view = view;
		_theme = theme;
