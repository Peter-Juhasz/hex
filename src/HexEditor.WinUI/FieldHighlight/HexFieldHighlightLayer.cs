...
internal sealed class HexFieldHighlightLayer : Canvas
{
	public HexFieldHighlightLayer(IGraphicalHexView view, ITagAggregator<FieldTag> tagAggregator, VisualTheme theme) : base()
	{
		_view = view;
		_theme = theme;
